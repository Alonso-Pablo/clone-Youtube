...
const SignIn = (props) => {
    ...
    const handleSubmit = event =>  {
        ...
        if (form.email === "" || form.name === "") return console.log(`All fields must be complete.`);
        props.setAccount(form);
            ...
            <LoginContainer>
                ...
                <section className="sign-in">
                    ...
                    <div className="sign-in__container">
                        ...
                        <span className="sign-in--instruction">Use a random Google Account</span>
                        
                        <form className="sign-in--name-email-form">

                            <label className="sign-in--name-label">Username</label>
                            ...
                            <label className="sign-in--email-label">Email or phone</label>
                        ...
                        <span className="sign-in-email--forgot-email">Forgot email?</span>

                        <div className="sign-in-email--more-instruction">
                        ...
                        <div className="sign-in-email--create-next">
                            <div className="sign-in-email--button-create">
                                <a className="create-account" href="#Put_a_random_email_and_click_next">
                                    Create account
                                </a>
                            </div>

                            <button className="sign-in-email--button-next" type="submit" onClick={handleSubmit}> 
